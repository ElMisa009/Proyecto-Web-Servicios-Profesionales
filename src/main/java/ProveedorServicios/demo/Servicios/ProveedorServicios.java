...
public class ProveedorServicios {
    ...
    public List<Proveedor> filtroBusqueda(String profesion) {
        List<Proveedor> proveedores = proveedorRepositorio.buscarPorProfesion(profesion);
        System.out.println(proveedores);

        return proveedores;
    }
    
    public void ElegirProfesion() {
        
        String mecanico = "Mecanico";
        String electricista = "Electricista";
        String contratista = "Contratista";
        String jardinero = "Jardinero";
        String plomero = "Plomero";
        String gastista = "Gasista";            
